...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@langchain/anthropic': path.resolve(__dirname, 'node_modules/@langchain/anthropic'),
  ...
  optimizeDeps: {
    include: ['zod', '@langchain/google-genai', '@langchain/openai', '@langchain/anthropic', '@langchain/core']
  }
});
